...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentArrayList.add(new Comment("wowo", "喔喔喔，我是评论10", 10));
        commentArrayList.add(new Comment("wowo", "喔喔喔，我是评论11", 11));
        commentArrayList.add(new Comment("wowo", "喔喔喔，我是评论12", 12));
        commentArrayList.add(new Comment("wowo", "喔喔喔，我是评论13", 13));
